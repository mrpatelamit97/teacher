   ...
   <a href="help form.html">Help</a>
    ...
    <table border="1" class="table table-bordered">
                                            <tr>
                                                ...
                                                <td>
                                                        <center> <span style="color: gray">UserId</span>
                                                    </td>
                                                  <td>
                       ...
                       <td>
                            <center>
                              <a href="FetchTeacherServlet?id=${teachers.userid}" class="btn btn-secondary form-rounded"  width="50px"> &emsp;View Details&emsp; 
                              </a>&emsp;&emsp;
                          ...
                          <td>
                            <center>
                              <a href="BatchServlet?id=${teachers.userid}" class="btn btn-secondary form-rounded"  width="50px"> &emsp;Show Batch&emsp; 
                              </a>&emsp;&emsp;
